...
module.exports = {
    ...
    OWNER: process.env.OWNER_NAME === undefined ? 'Stefanie' : process.env.OWNER_NAME,
    ...
    CAPTION_NAME: process.env.CAPTION_NAME === undefined ? '???? ?? ?????????' : process.env.CAPTION_NAME,
    ...
    MENU_LOGO: process.env.MENU_LOGO === undefined ?'https://telegra.ph/file/7a8c47c246bd16d90623d.jpg' : process.env.MENU_LOGO,

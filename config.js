...
module.exports = {
    ...
    BOT_NAME: process.env.BOT_NAME === undefined ? '👸ꜱᴛᴇꜰᴀɴɪᴇ�?' : process.env.BOT_NAME,
    ...
    STEFANIE: process.env.STEFANIE === undefined ? 'Amazone Alexa' : process.env.STEFANIE,
    ...
    AUTHOR: 'Prabath and Kaweesha',
    PKGPS: process.env.PKGPS === undefined ?'=xnxcom' : process.env.PKGPS,
    GIT: 'https://github.com/xmain12/ales',
    HEROKU: {
